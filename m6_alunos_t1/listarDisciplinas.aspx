<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listarDisciplinas.aspx.cs" Inherits="m6_alunos_t1.listarDisciplinas" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:m6_bd_alunos_t1ConnectionString %>" SelectCommand="select codigo,nome,nr_modulos as [Número de Módulos] from disciplinas"></asp:SqlDataSource>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="Número de Módulos" HeaderText="Número de Módulos" SortExpression="Número de Módulos" />
            </Columns>
        </asp:GridView>
