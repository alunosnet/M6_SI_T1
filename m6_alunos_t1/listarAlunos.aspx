<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listarAlunos.aspx.cs" Inherits="m6_alunos_t1.listarAlunos" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:m6_bd_alunos_t1ConnectionString %>" SelectCommand="SELECT nprocesso AS [Nº de Processo], nome, data_nascimento AS [Data Nascimento] FROM alunos"></asp:SqlDataSource>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Nº de Processo" DataSourceID="SqlDataSource1">
            <Columns>
                <asp:BoundField DataField="Nº de Processo" HeaderText="Nº de Processo" InsertVisible="False" ReadOnly="True" SortExpression="Nº de Processo" />
                <asp:BoundField DataField="nome" HeaderText="nome" SortExpression="nome" />
                <asp:BoundField DataField="Data Nascimento" HeaderText="Data Nascimento" SortExpression="Data Nascimento" />
            </Columns>
        </asp:GridView>
