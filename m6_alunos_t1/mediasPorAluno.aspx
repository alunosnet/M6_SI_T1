<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mediasPorAluno.aspx.cs" Inherits="m6_alunos_t1.mediasPorAluno" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:m6_bd_alunos_t1ConnectionString %>" SelectCommand="SELECT alunos.nome, AVG(Notas.nota) AS Média FROM Notas INNER JOIN alunos ON Notas.nprocesso = alunos.nprocesso GROUP BY alunos.nprocesso, alunos.nome"></asp:SqlDataSource>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
            <Columns>
                <asp:BoundField DataField="nome" HeaderText="nome" SortExpression="nome" />
                <asp:BoundField DataField="Média" HeaderText="Média" ReadOnly="True" SortExpression="Média" />
            </Columns>
        </asp:GridView>
