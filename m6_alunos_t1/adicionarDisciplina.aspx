<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adicionarDisciplina.aspx.cs" Inherits="m6_alunos_t1.adicionarDisciplina" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:m6_bd_alunos_t1ConnectionString %>" InsertCommand="INSERT INTO Disciplinas(nome, nr_modulos) VALUES (@nome, @nr_modulos)" SelectCommand="select * from disciplinas">
            <InsertParameters>
