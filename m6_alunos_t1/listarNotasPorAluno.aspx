<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listarNotasPorAluno.aspx.cs" Inherits="m6_alunos_t1.listarNotasPorAluno" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:m6_bd_alunos_t1ConnectionString %>" SelectCommand="SELECT alunos.nome, Notas.codigo_disciplina, Notas.nr_modulo, Notas.data, Notas.nota FROM Notas INNER JOIN alunos ON Notas.nprocesso = alunos.nprocesso WHERE (alunos.nome LIKE '%' + @nome + '%')">
            <SelectParameters>
