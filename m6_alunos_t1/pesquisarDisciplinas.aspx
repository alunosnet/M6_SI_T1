<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pesquisarDisciplinas.aspx.cs" Inherits="m6_alunos_t1.pesquisarDisciplinas" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:m6_bd_alunos_t1ConnectionString %>" SelectCommand="SELECT * from disciplinas
WHERE nome LIKE '%' + @nome + '%'">
        ...
        <br />
        Disciplina a pesquisar:<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
