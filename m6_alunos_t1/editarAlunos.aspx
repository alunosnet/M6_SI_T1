<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editarAlunos.aspx.cs" Inherits="m6_alunos_t1.editarAlunos" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:m6_bd_alunos_t1ConnectionString %>" DeleteCommand="DELETE FROM alunos WHERE (nprocesso = @nprocesso)" SelectCommand="select * from alunos" UpdateCommand="UPDATE alunos SET nome = @nome, data_nascimento = @data_nascimento WHERE (nprocesso = @nprocesso)">
            <DeleteParameters>
